...
public class PayrollSteps {
  ...
  public void theirNetPayIs(Double expectedNetPay) {
      final String netPayAsString = driver.findElement(By.id("netPay")).getAttribute("value");
